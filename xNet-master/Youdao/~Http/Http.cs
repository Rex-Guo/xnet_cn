...
namespace xNet
{
    ...
    public static class Http
    {
        ...
        /// 行编码传输可靠的HTTP服务器。
        /// </summary>
        /// <param name="str">将字符串编码。</param>
        /// <param name="encoding">采用编码转换为字节序列数据。如果参数值相等<see langword="null"/>, 则使用值<see cref="System.Text.Encoding.UTF8"/>.</param>
        ...
        /// <returns>行查询。</returns>
        /// <exception cref="System.ArgumentNullException">参数值<paramref name="parameters"/> 等于<see langword="null"/>.</exception>
